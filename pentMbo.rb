...
=begin
  ...
  Author:by MBOMA KAKESE Eric                                          
  mbomaerick401@gmail.com                                                                                                       
  https://github.com/Eric-mboma                                         
  https://gitlab.com/mbomaerick401 

    PenTMbo (Penetration Testing Mboma)
    ...
    along with PenTMbo.  If not, see <http://www.gnu.org/licenses/>.
...
$pb_log_file = File.dirname(__FILE__) + "/other/log/pentMbo_log_" + ENV['USER'] + ".log"
...
case banner
	...
	when 1
		...
		puts "    ____          _____              ____      ___"     
		puts "   |  _ \\ ___ _ _|_   _| | \\     / | |__)  /_/___\\  __"         
		puts "   | |_) / _ \\ '_ \\| | | | \\_  / | |  _ \\"
		puts "   |  __/  __/ | | | | | |         | |_) | (_) \>  <"
		puts "   |_|   \\___|_| |_|_| | |        | |____/  \\___/_/"
end
...
while option1 != "5"
	module_exec = true
	puts ""
	puts "--------- Menu by MBOMA KAKESE Eric" + " "*10 + "ruby#{RUBY_VERSION} @ #{RUBY_PLATFORM}"
	puts ""
	puts "1- Outils Cryptographie"
	puts ""
	puts "2- Outils Reséaux"
	puts ""
	puts "3- Web"
        puts ""
        puts "4- Ip grabber"
        puts ""
        puts "5- Geolocalisation ip"
        puts ""
        puts "6- Mass attack"
	puts ""
	puts "7- License & contact"
	puts ""
	puts "8- Retour"
	puts ""
	print "   -> "
	...
	case option1
		...
		when "2"
			...
			puts "6- MAC address geolocalisation (samy.pl)"
			puts ""
			puts "0- Retour"
			puts ""
			print "   -> "
			...
			case option2
				...
				when "1"
					if haspermission() == true
						...
						module_exec = false
						puts ""
						puts "Désolé, vous n'avez pas la permissions d'executer cet outils (root?)."
						puts ""
					end
				when "2"
